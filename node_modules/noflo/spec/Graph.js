...
describe('Graph', function() {
  describe('with new instance', function() {
    ...
    it('should get a name from constructor', function() {
      g = new noflo.graph.Graph('Foo bar', {
        caseSensitive: true
      });
  ...
  describe('loaded from JSON (with case sensitive port names)', function() {
    ...
    it('should produce a Graph', function(done) {
      return noflo.graph.loadJSON(json, function(err, instance) {
        if (err) {
          return done(err);
        }
        g = instance;
    ...
    describe('renaming a node', function() {
      ...
      it('should still be exported', function() {
        return chai.expect(g.inports.inPut.process).to.equal('Baz');
      });
...
describe('Case Insensitive Graph', function() {
  describe('Graph operations should convert port names to lowercase', function() {
    var g;
    g = null;
    beforeEach(function() {
      return g = new noflo.graph.Graph('Hola');
    });
    it('should have case sensitive property set to false', function() {
      return chai.expect(g.caseSensitive).to.equal(false);
    });
  ...
  return describe('Legacy exports loaded via JSON', function() {
    ...
    return describe('legacy exports with case sensitivity turned off', function() {
      it('should have two legacy exports', function(done) {
        chai.expect(g.exports).to.be.an('array');
        chai.expect(g.exports.length).to.equal(2);
        return done();
